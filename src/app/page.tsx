...
export default function Home() {
  ...
  const avatarUrl = user?.avatar
    ...
    : 'https://cdn.discordapp.com/avatars/880694914365685781/afbcd6184ee3b21f2887d7c08c95a899.png?size=256'; // Fallback to Tsuuchi icon
  ...
  return (
    <main className="min-h-dvh flex flex-col p-4">
      ...
      {/* Floating Bottom Footer Links */}
      <div className="mt-auto pt-12 pb-4 flex flex-col items-center gap-4">
        {/* Developer Pill */}
        <a 
